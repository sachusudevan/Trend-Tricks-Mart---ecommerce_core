...
var KTDatatablesServerSide = function() {
    ...
    var initDatatable = function() {
        ...
        dt = $("#ecommerce-group-datatable").DataTable({
            searchDelay: 500,
            serverSide: true,
            responsive: true,
            processing: true,
                    ...
                    render: function (data, type, row) {
                        ...
                        return `
                                <div class="d-flex justify-content-end flex-shrink-0">
                                    ...
                                    <a href="javascript:void(0)" data-id=${row.id} data-kt-group-table-filter="delete_row" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                                        <span class="svg-icon svg-icon-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    var handleStatusFilter = () => {
        const filterStatus = document.querySelector('[data-kt-ecommerce-group-filter="status"]');
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = document.querySelectorAll('[data-kt-group-table-filter="delete_row"]');
    ...
    var initToggleToolbar = function() {
        ...
        const container = document.querySelector('#ecommerce-group-datatable');
